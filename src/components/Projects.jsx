...
const projects = [
  ...
  },
  {
    ...
    description: 'A responsive beauty salon website with user authentication, appointment booking, and secure payment integration.',
    longDescription: 'eveloped a full-stack responsive beauty salon website built with the MERN stack, enabling seamless booking and payment experiences for salon customers. Implemented secure user authentication with JWT tokens and session management to protect customer data. Created a dynamic appointment booking system with real-time availability tracking, allowing users to schedule services and receive confirmation notifications. Integrated Stripe/payment gateway for secure payment processing with PCI compliance. Built a responsive UI with React.js for optimal viewing on mobile, tablet, and desktop devices. Designed RESTful APIs using Express.js and Node.js to handle user management, bookings, payments, and salon services. Utilized MongoDB for flexible data storage with collections for users, appointments, services, and transactions. Implemented comprehensive error handling and validation for form submissions and payment operations. Tested all features using Postman to ensure API reliability and proper data flow throughout the application.',
    ...
    category: 'fullstack',
    github: 'https://github.com/OsandaLakshitha/Lush-Beauty',
    live: 'https://lush-beauty.vercel.app/',
    featured: true,
    year: '2024',
    stats: {
      stars: 38,
  ...
  },
  {
    id: 4,
    title: 'Auto Pro',
    subtitle: 'Vehicle repairing and Spare parts website',
    description: 'A full-stack vehicle repair and spare parts website with user authentication, product search, cart management, and checkout flow.',
    longDescription: 'Developed a full-stack e-commerce platform for vehicle repair and spare parts management, engineered with HTML, CSS, and JavaScript for the frontend, Java for backend logic, and MySQL for robust data persistence. Implemented secure user authentication system with role-based access control, distinguishing between customers, mechanics, and administrators. Designed and optimized product search functionality with advanced filtering capabilities by vehicle type, part category, price range, and availability status. Built a dynamic shopping cart system with real-time inventory tracking, allowing users to add, modify, and remove items seamlessly. Engineered a complete checkout flow including shipping address validation, payment gateway integration, and order confirmation notifications. Created comprehensive REST APIs using Java backend to handle product listings, user management, cart operations, and order processing. Designed normalized MySQL database schema with tables for users, products, vehicle types, orders, inventory management, and transaction records. Implemented form validation on both client and server side to ensure data integrity and security. Conducted extensive testing including functional testing for all e-commerce workflows, usability testing for user experience optimization, and regression testing across browsers and devices. Ensured responsive design principles throughout, delivering optimal viewing experiences on mobile, tablet, and desktop platforms. Implemented error handling, logging mechanisms, and fallback recovery strategies for critical operations. Deployed live application on Vercel for production availability and reliability.',
    image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=800&h=600&fit=crop',
    technologies: ['React', 'Tailwind', 'JavaScript'],
    category: 'fullstack',
    github: 'https://github.com/OsandaLakshitha/AutoPro',
    live: 'https://auto-pro-eight.vercel.app/',
    featured: false,
    year: '2024',
    stats: {
      stars: 28,
  ...
  },
  {
    ...
    category: 'frontend',
    github: 'https://github.com/OsandaLakshitha/FoodieDelight',
    live: 'https://foodie-delight-gray.vercel.app/',
    featured: false,
    year: '2024',
    stats: {
      stars: 35,
